...
from spectral_analyzer.config import PROJECT_ROOT
...
def gen_gradient(height: int, stops: List[Tuple[float, RGBA]]) -> NDArray[np.uint8]:
    ...
    for stop in stops:
        ...
        gradient_array[previous_end_point:end_point] = (
            top_color_array + (bottom_color_array - top_color_array) * coefficient
        )
